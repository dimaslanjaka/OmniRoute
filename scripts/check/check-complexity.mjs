...
// complexity-baseline.json. The positional paths MUST match that scope (src+open-sse+bin)
// — ESLint flat config only walks the directories passed here, so a `files` glob for bin/
